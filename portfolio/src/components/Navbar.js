    ...
    <div className='absolute w-full flex justify-between p-4 items-center'>
      ...
      <div>
        <ul className='flex items-center gap-[2rem] justify-center text-gray-100 font-semibold text-2xl'>
          ...
          <li className=' hover:ring-4 hover:ring-rose-300 ease-in-out duration-200 px-3 py-2 rounded-lg cursor-pointer z-10'>
          ...
          <li className=' hover:ring-4 hover:ring-rose-300 ease-in-out duration-200 px-3 py-2 rounded-lg cursor-pointer text-center z-10'>
            <Link
              activeClass="active"
              to="about-me"
              spy={true}
