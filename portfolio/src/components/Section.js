...
function Section () {
  ...
  useEffect(() => {
    ...
    return (
        <body ref={divRef} id="about-me" class="flex flex-row h-[60vh]">
        ...
        <div class="about-me flex-1 bg-purple-800 flex items-center justify-center rounded-[4rem] shadow-2xl mr-40 overscroll-contain">
